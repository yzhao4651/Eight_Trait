...
##change the name of individuals in the phenotype data to the same of individuals in the genotypes
#myYmrMlMM$Taxa <- gsub("-", "\\.", myYmrMlMM$Taxa)
###making the datasets for the imputed SNP add YLd 
...
names(myYmrMlMMflo)
str(myYmrMlMMflo)
myYmrMlMMculm <- myYmrMlMM[,c(1,3:13,17:19,40:43)]
str(myYmrMlMMculm)
names(myYmrMlMMculm)
...
##names(myYmrMlMM)
#[1] "Taxa"      "Surv"      "CmDW_g"    "Cml_cm"    "CmD_BI_mm" "CmD_LI_mm" "CmN."      "Bcirc_cm"  "Yld_kg"    "SDW_kg"    "CCirc_cm"  "Lg"       
#[13] "GS"        "TFN."      "FNMain"    "FNsmall"   "FD"        "SRD"       "ADD"       "HD_1"      "FD_1"      "HD_50."    "FD_50."    "HW_1"     
#[25] "FW_1"      "HW_50"     "FW_50"     "GHW_1"     "GFW_1"     "GHW_50"    "GFW_50"    "HM_1"      "FM_1"      "HM_50"     "FM_50"     "fprind"   
#[37] "fprinW"    "fprinGW"   "fprinM"    "Yld"       "AIL"       "CmDW.V"    "Yld_1" 
##name changed 
#[1] "Taxa"      "Trait1"    "Trait2"    "Trait3"    "Trait4"    "Trait5"    "Trait6"    "Trait7"   "Trait8"    "Trait9"    "Trait10"   "Trait11"  
#[13]"Trait12"   "Trait13"    "Trait14"    "Trait15"   "Trait16"   "Trait17"   "Trait18"   "Trait19"   "Trait20"   "Trait21"   "Trait22"   "Trait23" 
#[25] "Trait24"   "Trait25"   "Trait26"   "Trait27"   "Trait28"   "Trait29"   "Trait30"    "Trait31"   "Trait32"    "Trait33"   "Trait34"   "Trait35" 
#[37] "Trait36"   "Trait37"   "Trait38"   "Trait39"   "Trait40"   "Trait41"   "Trait42"
...
myYmrMlMMculm <- myYmrMlMM[,c(1,3:13,17:19,40:43)]
str(myYmrMlMMculm)
myYmrMlMMculm<- myYmrMlMMculm[-which(rowSums(is.na(myYmrMlMMculm)) ==18),]
str(myYmrMlMMculm)
###write out the dataset
write.csv(myYmrMlMMculm, file = "mrMLMM2/myYmrMlMMculm4.csv", row.names = FALSE, na = "NA") ###this one used for the mrMLM software 
