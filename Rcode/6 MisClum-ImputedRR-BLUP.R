...
myGD <- read.csv("data/myGDimputedSNP19_chapter2.csv",row.names=1)
myGM <- read.csv("data/myGMimputedSNP19_chapter2.csv")
myQ<- read.csv("data/myQimputedSNP19_chapter2.csv",row.names=1)
str(myQ)
...
write.csv(gwasResults2, file = "rrBLUPim/rrBLUP_GWAS_results2.csv")

###this one for qq plots
out_start=4
out_end=41
for (i in out_start:out_end){
  mypath <- file.path("~/Documents/R-corde for miscanthus project/Miscanthus/rrBLUPim",
