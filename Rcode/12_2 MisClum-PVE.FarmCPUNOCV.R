##############################################################################
##########Two: Calculating PVE for results from FarmCPU NO CV ################
##############################################################################
...
##merge flowertrait and chapter 2 related traits 
myYall <- read.csv("data/myYimputedSNP19.csv")
myYall2 <- myYall[-9]
myYild <- read.csv("data/myYimputedSNP19_chapter2.csv")
myYild2 <- myYild[,c(1,12)]
Newyild <- merge(myY2, myYild2,by="Taxa")
colnames(Newyild)[which(names(Newyild)=="Yld")] <- "Yld_kg"
myY1 <- Newyild[,c(1:7,39,8:38)]
...
names(myY)
flo.1 <- read.csv("GAPIT0.05Result/FarmCPU0.05.PSNO.csv")
str(flo.1)
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus/FarmCPU0.05.36088imUP1")
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
extension <- "csv"
fileNames <- Sys.glob(paste("FarmCPU0.05.36088imUP1/*.", extension, sep = ""))
...
FarmCPUCVNOim$filename <- gsub('FarmCPU0.05.36088imUP1/Trait.', '', FarmCPUCVNOim$filename)
...
str(FarmCPUCVNOim.flo.S)
write.csv(FarmCPUCVNOim.flo.S,file="GAPIT0.05Result/FarmCPUCVNOim.flo.S.csv")
...
flo <- droplevels(flo)
levels(flo$Trait.name)
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus/FarmCPU0.05.F116up")
for (i in levels(flo$Trait.name)){
  Trait <- flo[which(flo$Trait.name== i),]
  if(nrow(Trait) >0) {
    write.csv(Trait,file= paste('Trait', i, 'csv', sep = '.'))
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
extension <- "csv"
fileNames <- Sys.glob(paste("FarmCPU0.05.F116up/*.", extension, sep = ""))
mzList = list()
for(i in 1:length(fileNames)){
  sample = read.csv(fileNames[i],row.names = 1)
  sample.PVE <- PVE.fun(sample,myY,myGD)
...
FarmCPU0.05.F116$filename <- gsub('FarmCPU0.05.F116up/Trait.', '', FarmCPU0.05.F116$filename)
...
flo <- droplevels(flo)
levels(flo$Trait.name)
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus/FarmCPU0.05.F96")
for (i in levels(flo$Trait.name)){
  Trait <- flo[which(flo$Trait.name== i),]
  if(nrow(Trait) >0) {
    write.csv(Trait,file= paste('Trait', i, 'csv', sep = '.'))
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
extension <- "csv"
fileNames <- Sys.glob(paste("FarmCPU0.05.F96/*.", extension, sep = ""))
mzList = list()
for(i in 1:length(fileNames)){
  sample = read.csv(fileNames[i],row.names = 1)
  sample.PVE <- PVE.fun(sample,myY,myGD)
...
#resultPVE1 <- plyr::ldply(mzList, data.frame)
FarmCPU0.05.F96 <- plyr::rbind.fill(mzList)
#resultPVE = do.call("rbind", mzList)
##combine all of the result with flo

levels(FarmCPU0.05.F96$filename)

FarmCPU0.05.F96$filename <- gsub('FarmCPU0.05.F96/Trait.', '', FarmCPU0.05.F96$filename)
FarmCPU0.05.F96$filename <- gsub('.csv', '', FarmCPU0.05.F96$filename)

levels(as.factor(FarmCPU0.05.F96$filename))

FarmCPU0.05.F96.1 <- unite(FarmCPU0.05.F96,"SNP.T",SNP,filename,sep="/")
flo.2 <- unite(flo,"SNP.T",SNP,Trait.name,sep="/")

FarmCPU0.05.F96.flo <- merge(flo.2,FarmCPU0.05.F96.1,by="SNP.T")
FarmCPU0.05.F96.flo.S <- separate(FarmCPU0.05.F96.flo, SNP.T, c("SNP","Trait.name"),sep="/")
...
flo <- droplevels(flo)
levels(flo$Trait.name)
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus/FarmCPU0.05.C124")
for (i in levels(flo$Trait.name)){
  Trait <- flo[which(flo$Trait.name== i),]
  if(nrow(Trait) >0) {
    write.csv(Trait,file= paste('Trait', i, 'csv', sep = '.'))
...
setwd("/Users/yonglizhao/Documents/R-corde for miscanthus project/Miscanthus")
extension <- "csv"
fileNames <- Sys.glob(paste("FarmCPU0.05.C124/*.", extension, sep = ""))
source("Function/PVE.fun.R")
mzList = list()
for(i in 1:length(fileNames)){
  sample = read.csv(fileNames[i],row.names = 1)
...
#resultPVE1 <- plyr::ldply(mzList, data.frame)
FarmCPU0.05.C124 <- plyr::rbind.fill(mzList)
#resultPVE = do.call("rbind", mzList)
##combine all of the result with flo

levels(FarmCPU0.05.C124$filename)

FarmCPU0.05.C124$filename <- gsub('FarmCPU0.05.C124/Trait.', '', FarmCPU0.05.C124$filename)
FarmCPU0.05.C124$filename <- gsub('.csv', '', FarmCPU0.05.C124$filename)

levels(as.factor(FarmCPU0.05.C124$filename))

FarmCPU0.05.C124.1 <- unite(FarmCPU0.05.C124,"SNP.T",SNP,filename,sep="/")
flo.2 <- unite(flo,"SNP.T",SNP,Trait.name,sep="/")

FarmCPU0.05.C124.flo <- merge(flo.2,FarmCPU0.05.C124.1,by="SNP.T")
FarmCPU0.05.C124.flo.S <- separate(FarmCPU0.05.C124.flo, SNP.T, c("SNP","Trait.name"),sep="/")


###combine all of the result
FarmCPU0.05.PVE.a <- do.call("rbind",list(FarmCPUCVNOim.flo.S,FarmCPU0.05.C106.flo.S,FarmCPU0.05.C116.flo.S,FarmCPU0.05.C124.flo.S))

write.csv(FarmCPU0.05.PVE.a,file="GAPIT0.05Result/FarmCPU0.05.PVE.a.1.csv")
